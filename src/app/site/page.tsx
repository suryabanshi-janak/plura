...
export default function Home() {
  return (
    <div>
      <section className='h-full w-full mt-20 md:pt-44 md:mt-[-70px] relative flex items-center justify-center flex-col'>
        <HomePattern />
        ...
        <div className='flex justify-center gap-4 flex-wrap mt-6'>
          {pricingCards.map((card) => (
            ...
            >
              <CardHeader>
                <CardTitle
                  className={cn(!card.isRecommended && 'text-muted-foreground')}
                >
                  {card.title}
                </CardTitle>
